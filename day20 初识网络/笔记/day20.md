...
假设 **alex** 上大学买了一台电脑，电脑里存了1部小电影，整宿整宿的在宿舍反复的看。

![image-20210204184431053](../assets/image-20210204184431053.png)

**alex** 如何想要和室友 **于超** 进行收发数据，可以通过一根网线来进行连接，并进行数据的传输。

![image-20210204185417337](../assets/image-20210204185417337.png)
...
![image-20210205143317465](../assets/image-20210205143317465.png)
...
![image-20210204205902286](../assets/image-20210204205902286.png)
...
![image-20210206092454106](../assets/image-20210206092454106.png)
...
```
二进制表示：11111011.10010111.11111111.00001111
...
- 问题1：如何确定网络地址和主机地址呢？
  ...
  此时，网络地址就是前22位 + 主机地址是后10位。你可能见过有些IP这样写 192.111.12.19/22，意思也是前22位是网络地址。
  ```
...
- 问题2：划分 网络地址 + 主机地址 的意义是什么？
  ...
  示例1：
  	...
  	示例网段的主机范围：11000000.10101000.00001010.00000001  ~  11000000.10101000.00001010.11111110
  	    ...
  	    特别提示：0和255不能用，因0代表网络地址；255为广播地址。
      
  	示例网段的主机范围：11000000.10101000.01100011.00000001  ~  11000000.10101000.01100011.11111110
  	                 --------------------------              --------------------------
  	                          网络地址                                   网络地址
...
<img src="assets/image-20210207212948961.png" alt="image-20210207212948961" style="zoom:50%;" />
...
假设你创业开发了一个网站，用户很难记住你的公网IP：`123.206.15.88`  。
...
了解域名是怎么回事之后？现在你如果想要让自己的网站通过域名来访问，应该怎么办呢？
...
- 客户端，放在右边用户电脑上
  ...
  client.connect(('123.206.15.88', 8001))
